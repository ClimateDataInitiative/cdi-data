...
INSERT INTO TERM (lexicon_identifier,context_identifier,term,description,is_root,url) 
   VALUES ('cdi','health','Population at risk','Specific group or subgroup that is more likely to be exposed, or is more sensitive to a certain substance than the general population.','FALSE','http://www.businessdictionary.com/definition/population-at-risk.html');
INSERT INTO TERM (lexicon_identifier,context_identifier,term,description,is_root,url) 
   VALUES ('concept-map','vectorBorneDisease','Population at risk','Specific group or subgroup that is more likely to be exposed, or is more sensitive to a certain substance than the general population.','FALSE','http://www.businessdictionary.com/definition/population-at-risk.html');
INSERT INTO TERM (lexicon_identifier,context_identifier,term,description,is_root,url) 
...
INSERT INTO TERM (lexicon_identifier,context_identifier,term,description,is_root,url) 
   VALUES ('cdi','health','Socio-economic risk factors','Risks determined by socioeconomic status, which is commonly conceptualized as the social standing or class of an individualor group. It is often measured as a combination of education, income and occupation.','FALSE','http://www.apa.org/topics/socioeconomic-status/');
INSERT INTO TERM (lexicon_identifier,context_identifier,term,description,is_root,url) 
   VALUES ('concept-map','vectorBorneDisease','Socio-economic risk factors','Risks determined by socioeconomic status, which is commonly conceptualized as the social standing or class of an individualor group. It is often measured as a combination of education, income and occupation.','FALSE','http://www.apa.org/topics/socioeconomic-status/');
INSERT INTO TERM (lexicon_identifier,context_identifier,term,description,is_root,url) 
